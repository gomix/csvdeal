...
class CaveguiasWorker
  ...
  def self.perform(params)
    ...
    File.open(File.expand_path(dst.path),"w+") do |f|
      ...
      h = "SerialCANTV1,rif-fecha1,ControlCANTV1,Cliente1,Direccion1,Region1,PesoGramos1,Remitente1,DireccionRemitente1,TipoDeEnvio1,CodigoDeBarra1\n"
      f.write(h)
